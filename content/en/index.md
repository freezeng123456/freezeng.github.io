...
> [!tip] Suggested route
> For a first visit, start with the [[en/computational-mathematics/knowledge-notes/time-parallelization/index\|time-parallelization method map]], then read the [[en/recommender-systems/onerec/end-to-end-pipeline\|OneRec end-to-end pipeline]]. The former shows how theory is organized; the latter shows how the implementation of a large system is organized.
