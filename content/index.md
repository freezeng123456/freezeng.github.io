...
| 领域                                 | 研究内容                                                                     | 知识整理                                                      |
| ------------------------------------ | ---------------------------------------------------------------------------- | ------------------------------------------------------------- |
| [[计算数学/index\|计算数学]]         | [[计算数学/个人科研/RSSE\|RSSE]]、[[计算数学/个人科研/Apolarity\|Apolarity]] | [[计算数学/时间并行计算/index\|双曲与抛物问题的时间并行计算]] |
...
> [!tip] 推荐阅读路径
> 如果第一次来，可先看 [[计算数学/时间并行计算/index\|时间并行方法地图]]，再看 [[推荐系统理论/OneRec/端到端链路\|OneRec 端到端链路]]。前者展示如何组织理论，后者展示如何组织大型系统实现。

## 当前建设状态

- 计算数学科研：已整理两个研究方向的核心洞见和结果。
- 时间并行计算：按 Acta Numerica 论文五章建立笔记，并接入 Python 可视化验证。
