...
> [!note] 覆盖进度
> 编号 12、20、30、31、39 已有逐式核对的精读内容。编号 46、53、59、65、71、77、84 的精读页仍在补充；编号 85 的完整逐节精读见[[computational-mathematics/knowledge-notes/time-parallelization/index|时间并行专题]]。
