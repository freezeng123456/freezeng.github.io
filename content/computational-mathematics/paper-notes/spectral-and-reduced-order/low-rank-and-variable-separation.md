...
> [!note] 本页覆盖
> 编号 **15**（_SIAM J. Sci. Comput._ 37(2), 2015）、**17**（_J. Comput. Phys._ 303, 2015）、**83**（_SIAM J. Sci. Comput._ 47(3), 2025）。编号 17 的期刊正文需订阅访问且无预印本，该节区分「本文可确认的内容」与「所改造的通用框架」；编号 83 依据其预印本摘要撰写，可核实范围在该节内标出。
