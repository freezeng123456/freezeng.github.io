...
### 3.2.3 Theorem 3.1：Robin 参数的 minimax 选择
...
## 3.2.6 二阶双曲问题：Dirichlet 条件也能有限步收敛
...
## 3.2.7 Figure 3.2：红黑 SWR 如何推进正确区域
...
| WR 分裂与 SWR 动机                | 3.2         | 连续区域分解、WR 分裂困难、OSWR 设计目标                      |
| (3.1)                             | 3.2.2       | 两个子域的 PDE、物理边界、Robin 交换和初值                    |
| (3.2a)–(3.2c), (3.3), Theorem 3.1 | 3.2.3       | 参数缩放、单频因子、两种参数区间、最坏频率界和 Dirichlet 极限 |
| Figure 3.1                        | 3.2.4       | 完整原图、参数、停止准则、理论与实验差异                      |
| Ventcel 与卷积条件                | 3.2.5       | 最优算子形式、渐近因子、非局部代价                            |
| (3.4), Theorem 3.2                | 3.2.6       | 双子域迭代、有限步条件与误差结论                              |
| Figures 3.2–3.3                   | 3.2.7–3.2.8 | 完整原图、红黑推进、MTP/UTP 和残差自适应                      |
