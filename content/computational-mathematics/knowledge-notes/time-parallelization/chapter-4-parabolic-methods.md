...
> [!note] 阅读范围
> 本章对应论文 Section 4（pp. 443–481）。第 4.1–4.6 节依照原文解释历史、算法、定理和 Figures 4.1–4.22；第 4.7 节集中放置本站的 Python 复现结果。理论收敛因子、实测迭代曲线和墙钟性能采用不同标签。
...
## 4.7 本站补充：Python 复现结果

### 4.7.1 Parareal 基线与 Figure 4.5
...
### 4.7.2 MGRiT 基线与 Figures 4.9–4.10
...
| Section 4.2，pp. 444–452       | 4.2、4.7.1 | Parareal 更新、Theorems 4.1–4.4、Figures 4.1–4.5、非线性与双曲退化                 |
| Section 4.3，pp. 452–455       | 4.3        | 配置方程、SDC、FAS 传递、PFASST 迭代与 Figure 4.6                                  |
| Section 4.4，pp. 455–460       | 4.4、4.7.2 | FCF 结构、Theorems 4.5–4.6、Figures 4.7–4.11、等成本比较与 Burgers                 |
| Section 4.5，pp. 460–472       | 4.5        | 两种对角化位置、Theorems 4.7–4.8、Figures 4.12–4.17、非线性和 MGRiT 一致性条件     |
| Section 4.6，pp. 472–481       | 4.6、4.7.3 | all-at-once STMG、块 Jacobi、Theorem 4.9、Figures 4.18–4.22、Table 4.1、非线性 FAS |
