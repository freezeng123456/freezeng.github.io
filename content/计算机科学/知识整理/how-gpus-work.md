...
> [!note] 来源与适用范围
> 本页是对 KM 文章《[AI Infra入门：GPU是如何工作的](https://km.woa.com/articles/show/631982?kmref=profile_feeds)》（更新于 2025-10-25）的独立结构化笔记，不是原文转载。公开版保留技术主线、示例参数与实验结果，省略人员、组织、评论和内部信息。驱动命令格式、队列实现与调度细节会随 GPU 架构、驱动和 CUDA 版本变化；本文在这些位置采用公开文档支持的抽象模型。
